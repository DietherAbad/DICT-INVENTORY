...
function TableRow({ data }) {
  ...
  return (
    <tr>
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-center">{data.serial_no}</td>
...
function Reportstablegovnetequipments() {
  ...
  return (
    <div className="w-full sm:px-6 pt-10">
      <div className="flex items-center mb-4">
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">REPORTS TABLE FOR GOVNET EQUIPMENTS</p>
        <input
          type="text"
          placeholder="Search..."
          value={searchQuery}
...
export default Reportstablegovnetequipments;
