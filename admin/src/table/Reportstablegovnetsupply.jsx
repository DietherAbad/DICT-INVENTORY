...
function TableRow({ data }) {
  ...
  return (
    <tr>
      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-left">{data.stock_no}</td>
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_qty}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.unitofmeasure}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_unit_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_total_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.purchase_qty}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.purchase_unit_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.purchase_total_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.distribution_qty}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.distribution_unit_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.distribution_total_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_qty}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_unit_cost}</td>
      <td className="px-6 py-4 whitespace-nowrap text-sm text-left">{data.balance_total_cost}</td>
    ...
    <div className="w-full sm:px-6 pt-10">
      ...
      <div className="flex flex-col gap-3 mb-4">
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-slate-900">
          Reports Table for GovNet Supplies
        </p>
