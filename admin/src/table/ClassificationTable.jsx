  ...
  return (
    <tr className="hover:bg-gray-100 transition duration-150 ease-in-out">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-center">
        <button onClick={() => handleDeleteClick(data)} className="bg-indigo-500 px-3 py-2 rounded text-white hover:bg-indigo-700 transition duration-150 ease-in-out">
          Delete
        </button>
      </td>
    </tr>
...
function ClassificationTable() {
  ...
  const handleDeleteConfirm = () => {
    if (userToDelete) {
      fetch(`${BASE_URL}/classification/${userToDelete._id}`, {
        method: 'DELETE',
      })
      .then(response => {
        if (!response.ok) {
  ...
  return (
    <div className="w-full sm:px-6 pt-10">
      <div className="flex items-center mb-4">
        ...
        <button onClick={handleAddClick} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-auto mr-2 transition duration-150 ease-in-out">
          Add
        </button>
        <input
          type="text"
      ...
      {showAddForm && (
        <div className="bg-white shadow px-4 py-4 md:px-10 mb-4">
          <h2 className="text-lg font-semibold mb-4">Add New Classification</h2>
      ...
      {showSuccessPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mb-4">New classification added successfully.</p>
            <button
