...
function Stocktableofficemotorandvehicles() {
  ...
  useEffect(() => {
    fetch(`${BASE_URL}/inventoryofficemotorandvehicle/inventory`)
      .then((response) => {
        if (!response.ok) {
  ...
  return (
    <div className="w-full sm:px-6 pt-10">
      <div className="flex items-center mb-4">
        ...
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500 leading-tight shadow-sm">
          STOCK TABLE FOR MOTOR AND VEHICLES
        </p>
        <input
          type="text"
          placeholder="Search..."
...
export default Stocktableofficemotorandvehicles;
