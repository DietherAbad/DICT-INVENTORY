...
export default function Checkitemfreewifi() {
    ...
    useEffect(() => {
        fetch(`${BASE_URL}/inventoryFreewifi/inventory/${id}`)
            .then(response => {
                if (!response.ok) {
...
{inventory.itemName}
    ...
    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-500 bg-opacity-75">
        <div className="bg-white p-8 rounded-lg">
            ...
            <p className="text-center mt-4">Issue to:</p>
            <div className="mt-4">
                <input type="text" className="border border-gray-300 rounded-md w-full py-2 px-3" placeholder="Enter name" />
            </div>
            <div className="mt-4">
                <textarea className="border border-gray-300 rounded-md w-full py-2 px-3" rows="4" placeholder="Remarks"></textarea>
            </div>
