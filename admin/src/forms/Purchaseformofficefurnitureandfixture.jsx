...
export function Purchaseformfurnitureandfixture() {
  ...
  useEffect(() => {
    const fetchClassificationOptions = async () => {
      try {
        ...
        const classifications = data.filter(item => item.designation === "Furniture & Fixture");
  ...
  useEffect(() => {
    const fetchUnitMeasures = async () => {
      try {
        ...
        const data = await res.json();
        const filteredData = data.filter(item => item.designation === "Furniture & Fixture");
  ...
  useEffect(() => {
    const fetchIssuedToOptions = async () => {
      try {
        ...
        setIssuedToOptions(filteredUsers.map(user => user.username));
      } catch (error) {
  ...
  function showDropDownMenuProject() {
  ...
  const handleStockinAndSubmission = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/inventoryofficefurnitureandfixture/inventory`, {
        method: 'post',
        headers: {
                      ...
                      <div className="flex items-center instance group">
                        ...
                        <div className="pl-3 heading-container">
                          <p className="text-base font-medium leading-none text-slate-800 group-hover:text-indigo-700">
                            PURCHASE OFFICE FURNITURE AND FIXTURES
                          </p>
                        </div>
                      </div>
                    </a>
                ...
                <div className="mt-10 px-7">
                  ...
                  <div className="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7">
                    ...
                    <div>
                      ...
                      <p className="mt-3 text-xs leading-[15px] text-gray-600">
                        If not found, add a designation.
                      </p>
                    </div>
                    <div>
                      <p className="text-base font-medium leading-none text-gray-800">
                      ...
                      <div className="relative top-1">
                        <div className="relative w-full mt-2 border border-gray-300 rounded outline-none dropdown-one">
                          <button
                            onClick={showDropDownMenuProject}
                            className="relative flex items-center justify-between w-full px-5 py-4"
                          >
                            <span
                              className="pr-4 text-sm font-medium text-gray-600"
                      ...
                      <p className="mt-3 text-xs leading-[15px] text-gray-600">
                        Select the project related to the purchase.
                      </p>
                    </div>
                    <div>
                      <p className="text-base font-medium leading-none text-gray-800">
