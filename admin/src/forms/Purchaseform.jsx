...
export function Purchaseform() {
  ...
  const projectOptions = ['General', 'eLGU', 'FreeWifi', 'IIDB', 'ILCDB', 'Tech4Ed']; // Project options
  ...
  function showDropDownMenuProject() { // Function to toggle project dropdown
  ...
  useEffect(() => {
    setStock(prevStock => ({
      ...prevStock,
      stock_unit_cost: prevStock.purchase_unit_cost,
      stock_total_cost: prevStock.purchase_unit_cost * prevStock.purchase_qty,
      purchase_total_cost: prevStock.purchase_unit_cost * prevStock.purchase_qty,
      balance_qty: prevStock.purchase_qty,
      stock_qty: prevStock.purchase_qty,
      balance_unit_cost: prevStock.purchase_unit_cost,
      balance_total_cost: prevStock.purchase_unit_cost * prevStock.purchase_qty
    }));
  }, [stock.purchase_unit_cost, stock.purchase_qty]);
  ...
  const handleStockinAndSubmission = async (e) => {
    ...
    if (!stock.classification || !stock.unitofmeasure || !stock.itemName || !stock.purchase_qty || !stock.purchase_unit_cost || !stock.date || !stock.project) {
                  ...
                  <div className="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7 ">
                        ...
                        <div className="relative w-full mt-2 border border-gray-300 rounded outline-none">
                          ...
                          >
                            ...
                            <svg
                              ...
                              width={10}
                              height={6} fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                    ...
                    <div>
                      ...
                      <div className="relative top-1">
                        <div className="relative w-full mt-2 border border-gray-300 rounded outline-none dropdown-one">
                          ...
                          >
                            {filterOptions(unitMeasureOptions).map((option, index) => (
                              <a key={index} href="javascript:void(0)" className="hover">
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded"
                                  onClick={() => {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleInputChange('purchase_unit_cost', e.target.value)}
                      />
                      ...
                      <div className="relative top-1">
                        <div className="relative w-full mt-2 border border-gray-300 rounded outline-none">
                          ...
                          >
                            <span
                              className="pr-4 text-sm font-medium text-gray-600"
                              id="drop-down-content-setter-project"
                            >
                              {stock.project || 'Select'}
                            </span>
                            <svg
                              id="rotate-project"
                              className={`absolute z-10 cursor-pointer right-5 ${!isProjectDropdownOpen ? '' : 'rotate-180'}`}
                              width={10}
                              height={6}
                              fill="none"
                              xmlns="http://www.w3.org/2000/svg"
