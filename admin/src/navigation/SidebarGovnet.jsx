...
export default function Sidebar() {
    ...
    const navtablesupply = () => {
        navigate('/stocktablegovnetsupply')
    }

    const navtableequip = () => {
        navigate('/stocktablegovnetequipments')
    }

    const navtablereportequip = () => {
        navigate('/stocktablegovnetequipments')
    }
    const navtablereportsupply = () => {
        navigate('/reportstablegovnetsupply')
    }


    return (
        <div className="h-full">
            <div className="rounded-r bg-gradient-to-r from-slate-950 via-slate-900 to-slate-950 border-b border-slate-800/80 xl:hidden flex justify-between w-full p-5 items-center ">
                <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/15">
                        <img src={DICT} alt="DICT" className="h-7 w-7 object-contain" />
                    </div>
                    <div>
                        <p className="text-sm font-semibold text-white">DICT</p>
                        <p className="text-[11px] text-slate-300">Govnet Inventory</p>
                    </div>
                </div>
                <div aria-label="toggler" className="flex justify-center items-center">
                    <button aria-label="open" id="open" onClick={()=>setShow(true)} className={`${show ? 'hidden' : ''} rounded-lg p-2 text-white hover:bg-slate-800/80 focus:outline-none focus:ring-2`}>
                    ...
                    <button aria-label="close" id="close" onClick={()=>setShow(false)} className={`${show ? '' : 'hidden'} rounded-lg p-2 text-white hover:bg-slate-800/80 focus:outline-none focus:ring-2`}>
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div id="Main" className={`${show ? 'translate-x-0' : '-translate-x-full'} xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  w-full sm:w-64 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-r border-slate-800/80 flex-col`}>
                <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-white/10 ring-1 ring-white/15">
                        <img src={DICT} alt="DICT" className="h-8 w-8 object-contain" />
                    </div>
                    <div>
                        <p className="text-base font-semibold text-white">DICT</p>
                        <p className="text-xs text-slate-300">Govnet Inventory</p>
                    </div>
                </div>
                <div className="mt-4 flex flex-col justify-start items-center px-4 w-full border-slate-800/70 border-b space-y-2 pb-4 ">
                    <button onClick={navhome}className="flex jusitfy-start items-center space-x-4 w-full rounded-lg px-3 py-2 text-left text-white/90 hover:bg-slate-800/80 focus:outline-none focus:ring-2 focus:ring-slate-600/60">
                    ...
                    <button onClick={navform}className="flex jusitfy-start items-center w-full space-x-4 rounded-lg px-3 py-2 text-left text-white/90 hover:bg-slate-800/80 focus:outline-none focus:ring-2 focus:ring-slate-600/60">
                    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-base leading-4 ">Purchase</p>
                    </button>
                </div>
                <div className="flex flex-col justify-start items-center   px-6 border-b border-slate-800/70 w-full  ">
                    <button onClick={()=>setMenuValue(0)} className="focus:outline-none text-white flex justify-between items-center w-full py-5 space-x-14  ">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-300">Govnet Equipments</p>
                    ...
                    <div id="menu1" className={`${menu[0] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <button onClick={navtableequip} className="flex justify-start items-center space-x-4 hover:text-white hover:bg-slate-800/80 text-slate-300 rounded-lg px-3 py-2  w-full md:w-52">
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button onClick={navtablereportequip}className="flex justify-start items-center space-x-4 hover:text-white hover:bg-slate-800/80 text-slate-300 rounded-lg px-3 py-2 w-full md:w-52">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 8.00002C15.1046 8.00002 16 7.10459 16 6.00002C16 4.89545 15.1046 4.00002 14 4.00002C12.8954 4.00002 12 4.89545 12 6.00002C12 7.10459 12.8954 8.00002 14 8.00002Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M4 6H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <div className="flex flex-col justify-start items-center   px-6 border-b border-slate-800/70 w-full  ">
                    <button onClick={()=>setMenuValue(1)} className="focus:outline-none text-white flex justify-between items-center w-full py-5 space-x-14  ">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-300">Govnet Supplies</p>
                    ...
                    <div id="menu1" className={`${menu[1] ? 'flex' : 'hidden'} justify-start  flex-col w-full md:w-auto items-start pb-1 `}>
                        <button onClick={navtablesupply} className="flex justify-start items-center space-x-4 hover:text-white hover:bg-slate-800/80 text-slate-300 rounded-lg px-3 py-2  w-full md:w-52">
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 8.00002C15.1046 8.00002 16 7.10459 16 6.00002C16 4.89545 15.1046 4.00002 14 4.00002C12.8954 4.00002 12 4.89545 12 6.00002C12 7.10459 12.8954 8.00002 14 8.00002Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M4 6H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <button className="flex justify-start items-center space-x-4 hover:text-white hover:bg-slate-800/80 text-slate-300 rounded-lg px-3 py-2  w-full md:w-52">
                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 21H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M10 21V3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M10 4L19 8L10 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        ...
                        <button onClick={navtablereportsupply}className="flex justify-start items-center space-x-4 hover:text-white hover:bg-slate-800/80 text-slate-300 rounded-lg px-3 py-2 w-full md:w-52">
                            <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 8.00002C15.1046 8.00002 16 7.10459 16 6.00002C16 4.89545 15.1046 4.00002 14 4.00002C12.8954 4.00002 12 4.89545 12 6.00002C12 7.10459 12.8954 8.00002 14 8.00002Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M4 6H12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16 6H20" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
