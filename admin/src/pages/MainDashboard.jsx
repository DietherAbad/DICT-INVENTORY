...
import profileIcon from '../assets/profile-icon.png'; // Add your profile icon image
...
export default function MainDashboard() {
  ...
  const handleLogout = () => {
    ...
    setTimeout(() => {
      navigate('/login');
    }, 2000); // Show the popup for 2 seconds before redirecting
  };
  ...
  <div className="container mx-auto flex justify-between items-center px-4">
    <div className="flex items-center">
      <img src={logo} alt="DICT Logo" className="h-12 mr-4" />
    </div>
    <div className="flex items-center">
      <span className="mr-4 text-gray-800 dark:text-white text-lg font-semibold">
      ...
      <div className="relative">
        ...
        />
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-md py-2 z-50 shadow-lg">
            <Link to="/checkuser" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">
              Manage My Account
            </Link>
            <button
      ...
      <section className="mx-auto container py-20 px-4">
        <div className="flex justify-center items-center flex-col">
          <div className="lg:text-6xl md:text-5xl text-4xl font-black leading-10 text-center text-gray-800 dark:text-white">
            <h1>DICT REGION 2 INVENTORY</h1>
          </div>
          <div className="pt-24 grid lg:grid-cols-3 md:grid-cols-2 justify-center items-center gap-y-20 gap-x-16 lg:gap-x-20 xl:px-20">
            <Link to="/officedashboard">
              <div className="cursor-pointer hover:shadow py-6 px-4 rounded-xl w-60 flex justify-center items-center flex-col bg-white dark:bg-gray-800">
                <div className="mb-6">
      ...
      {showLogoutPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p className="mb-4">You have been logged out successfully.</p>
          </div>
        </div>
      )}
    </div>
